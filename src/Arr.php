...
/**
     ...
     *
     * @param $data
     * @param bool $firstRowIsKey
     * @param bool $output
     * @param bool $bootstrap
     * @param null $id
     * @return string
     */
    public static function toHtml($data, $firstRowIsKey = true, $output = false, $bootstrap = true, $id = null)
    {
        if ($bootstrap == "datatable") {
...
<link rel="stylesheet" href="//cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
...
';
        ...
        $html .= "<div class='table-responsive'><table id='{$id}' class='table table-bordered'>";
